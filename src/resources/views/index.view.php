...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        <a class="navbar-brand" href="{{ redirect('/') }}">{{ $_ENV['APP_NAME'] }}</a>
    ...
    <main role="main" class="container">
        ...
        <div class="portfolio">
            ...
            <p class="lead pt-2">
                ...
                <a class="clean-link" href="https://twitter.com/adeastwood" target="_blank" title="twitter" rel="noreferrer">
                    <i class="text-dark clean-link fab fa-twitter pr-3 h3"></i>
                </a>
                <a class="clean-link" href="https://github.com/aeastwood" target="_blank" title="Github" rel="noreferrer">
                    <i class="text-dark clean-link fab fa-github pr-3 h3"></i>
                </a>
                <a class="clean-link" href="#" title="Email Me" data-toggle="modal" data-target="#contactModal" rel="noreferrer">
